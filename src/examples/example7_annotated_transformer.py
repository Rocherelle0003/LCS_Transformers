...
def visualize_lr_schedule():
   ...
   plt.tight_layout()
   plt.savefig('src/tmp/noam_lr_schedule.png', dpi=150)
   plt.close()
   
   print("\nVisualization saved to src/tmp/noam_lr_schedule.png")
   print("""
...
def demonstrate_label_smoothing():
   ...
   plt.tight_layout()
   plt.savefig('src/tmp/label_smoothing.png', dpi=150)
   plt.close()
   
   print("\nVisualization saved to src/tmp/label_smoothing.png")
   print(f"""
Hard Labels:
 Class 3: 1.0
 Others:  0.0
