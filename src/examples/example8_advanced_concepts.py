...
""")
    ...
    plt.tight_layout()
    plt.savefig('/tmp/complexity_analysis.png', dpi=150)
    plt.close()
    
    print("\nVisualization saved to /tmp/complexity_analysis.png")
    print("""
KEY INSIGHTS:
─────────────
...
""")
    ...
    plt.suptitle('Polygon Types for Sequence Modeling\n(Vertices numbered in sequence order)', 
                 fontsize=14, y=1.02)
    plt.tight_layout()
    plt.savefig('/tmp/polygon_examples.png', dpi=150, bbox_inches='tight')
    plt.close()
    
    print("\nVisualization saved to /tmp/polygon_examples.png")
...
""")
    ...
    plt.tight_layout()
    plt.savefig('/tmp/polygon_attention.png', dpi=150, bbox_inches='tight')
    plt.close()
    
    print("\nVisualization saved to /tmp/polygon_attention.png")
