...
def illustrate_sentence_attention():
    ...
    plt.tight_layout()
    plt.savefig('/tmp/sentence_attention.png', dpi=150, bbox_inches='tight')
    plt.close()
    
    print("\nVisualization saved to /tmp/sentence_attention.png")
    print("\nKey observations:")
...
def illustrate_positional_encoding_patterns():
    ...
    plt.tight_layout()
    plt.savefig('/tmp/positional_encoding_patterns.png', dpi=150, bbox_inches='tight')
    plt.close()
    
    print("\nVisualization saved to /tmp/positional_encoding_patterns.png")
...
def illustrate_multi_head_specialization():
    ...
    plt.suptitle('Different Attention Heads Learn Different Patterns\n(Each head sees the sentence differently)', 
                 fontsize=14, y=1.02)
    plt.tight_layout()
    plt.savefig('/tmp/multi_head_specialization.png', dpi=150, bbox_inches='tight')
    plt.close()
    
    print("\nVisualization saved to /tmp/multi_head_specialization.png")
    print("""
